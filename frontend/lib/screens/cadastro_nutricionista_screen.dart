/// Tela de Cadastro do Nutricionista do Meu Virtual Nutri.
///
/// Especificada no documento de requisitos (tela 3):
/// - Possui 5 campos de texto:
///   1. Nome Completo ('Dr(a). Seu Nome')
///   2. Email ('seu@email.com')
///   3. Numero do CRN ('CRN 12345' com dica 'Insira seu numero de registro profissional')
///   4. Senha ('••••••••')
///   5. Confirmar Senha ('••••••••')
/// - Possui botoes de acao:
///   1. Olho para alternar visibilidade do campo Senha.
///   2. Olho para alternar visibilidade do campo Confirmacao de Senha.
///   3. 'criar conta' (persiste os dados e o CRN no banco de dados e direciona a tela principal do nutricionista).
...
class CadastroNutricionistaScreen extends StatefulWidget {
  const CadastroNutricionistaScreen({
    super.key,
  ...
  @override
  State<CadastroNutricionistaScreen> createState() => _CadastroNutricionistaScreenState();
}
...
class _CadastroNutricionistaScreenState extends State<CadastroNutricionistaScreen> {
  ...
  /// Submete o formulario e cadastra o novo nutricionista na API.
  Future<void> _criarConta() async {
    ...
    try {
      final usuario = await widget.authService.cadastrarNutricionista(
      ...
      if (!mounted) return;
      // Retorna e notifica para abrir a tela do nutricionista
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // --- Campo 3: Numero do CRN ---
                  AuthTextField(
                    label: 'Numero do CRN',
                    controller: _crnController,
                    hint: 'CRN 12345',
                    helperText: 'Insira seu numero de registro profissional',
                    prefixIcon: Icons.badge_outlined,
                    validator: (valor) {
                      if (valor == null || valor.trim().isEmpty) {
                        return 'Informe seu numero de CRN';
                      }
                      return null;
                    },
                  ),
                  ...
                  // --- Campo 4: Senha (com Botao 1: Olho) ---
                  AuthTextField(
                    label: 'Senha',
                  ...
                  // --- Campo 5: Confirmar Senha (com Botao 2: Olho) ---
                  AuthTextField(
                  ...
                  // --- Botao: Ja tem uma conta? Voltar a tela de login ---
                  Row(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      const Text(
